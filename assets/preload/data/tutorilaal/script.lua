...
function onCreate()
         makeLuaSprite('win', 'achievements/Tutoriallalalal', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'The more you know', 400, 20, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the Tutorial', 200, 120, 40) -- change your description text
